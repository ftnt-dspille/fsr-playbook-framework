...
_FALLBACK_TRIAGE_PROMPT = (
    ...
    "emit_action_card for analyst approval -- never run it silently. When the "
    "user explicitly ORDERED that action, pass requested_by='analyst' on the "
    "card; otherwise leave it unset. Do not "
