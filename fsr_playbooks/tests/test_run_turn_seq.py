...
class _FakeProvider:
    ...
    async def stream(self, *, system, messages, tools, tags=None, case_state=None, max_tool_turns=None) -> AsyncIterator:
...
def test_run_turn_timeout_surfaces_error_event():
    ...
    class _HangProvider:
        async def stream(self, *, system, messages, tools, tags=None, case_state=None, max_tool_turns=None):
