...
Usage:
    python tooling/scratch/gen_fs_recipes.py                  # print to stdout
    python tooling/scratch/gen_fs_recipes.py --out recipes.yaml
    python tooling/scratch/gen_fs_recipes.py --scenario vpn_tunnel_down
"""
...
def _dump_yaml(recipes: list[dict[str, Any]]) -> str:
    ...
    header = (
        "# GENERATED by tooling/scratch/gen_fs_recipes.py from "
