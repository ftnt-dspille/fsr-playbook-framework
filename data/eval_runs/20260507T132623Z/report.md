# Eval run `20260507T132623Z`

- ts: 2026-05-07T13:26:23.086663+00:00
- live: False
- tasks: 15
- models: gold, echo
...
|---|---|---|---|---|---|---|---|---:|---:|
| `gold` | `hello_connector` | ✓ | ✓ | – | ✓ | – | ✓ | 4/4 | 37 |
| `gold` | `decision_branch` | ✓ | ✓ | – | ✓ | – | ✓ | 4/4 | 37 |
| `gold` | `alert_action_var_chain` | ✓ | ✗ | – | ✓ | – | ✓ | 3/4 | 38 |
| `gold` | `record_action_trigger` | ✓ | ✗ | – | ✓ | – | ✓ | 3/4 | 38 |
| `gold` | `alert_on_create` | ✓ | ✗ | – | ✓ | – | ✓ | 3/4 | 35 |
| `gold` | `alert_on_status_change` | ✓ | ✗ | – | ✓ | – | ✓ | 3/4 | 37 |
| `gold` | `code_snippet` | ✓ | ✓ | – | ✓ | – | ✓ | 4/4 | 34 |
| `gold` | `delay_step` | ✓ | ✓ | – | ✓ | – | ✓ | 4/4 | 34 |
| `gold` | `for_each_loop` | ✓ | ✗ | – | ✓ | – | ✓ | 3/4 | 37 |
| `gold` | `manual_input_branch` | ✓ | ✓ | – | ✓ | – | ✓ | 4/4 | 39 |
| `gold` | `record_create` | ✓ | ✓ | – | ✓ | – | ✓ | 4/4 | 36 |
| `gold` | `record_find_update` | ✓ | ✗ | – | ✓ | – | ✓ | 3/4 | 37 |
| `gold` | `virustotal_ip` | ✓ | ✗ | – | ✓ | – | ✓ | 3/4 | 41 |
| `gold` | `manual_input_then_act` | ✓ | ✓ | – | ✓ | – | ✓ | 4/4 | 38 |
