# Eval run `20260507T113214Z`

- ts: 2026-05-07T11:32:14.328338+00:00
- live: False
- tasks: 15
- models: gold, echo
...
|---|---|---|---|---|---|---|---|---:|---:|
| `gold` | `hello_connector` | ✓ | ✓ | – | ✓ | – | ✓ | 4/4 | 34 |
| `gold` | `decision_branch` | ✓ | ✓ | – | ✓ | – | ✓ | 4/4 | 35 |
| `gold` | `alert_action_var_chain` | ✓ | ✗ | – | ✓ | – | ✓ | 3/4 | 37 |
| `gold` | `record_action_trigger` | ✓ | ✗ | – | ✓ | – | ✓ | 3/4 | 36 |
| `gold` | `alert_on_create` | ✓ | ✗ | – | ✓ | – | ✓ | 3/4 | 35 |
| `gold` | `alert_on_status_change` | ✓ | ✗ | – | ✓ | – | ✓ | 3/4 | 36 |
| `gold` | `code_snippet` | ✓ | ✓ | – | ✓ | – | ✓ | 4/4 | 35 |
