...
from fsr_core.llm.tools import SAFE_TOOLS, TOOL_TIERS
...
def test_conn_state_keeps_unknown_distinct_from_down():
    from fsr_core.mcp_server.tools_noc import _fmg_conn_state
...
def test_digest_tags_model_device():
    from fsr_core.mcp_server.tools_noc import _fmg_digest_device
